#ifndef ANDROID_MEDIADEF_H
#define ANDROID_MEDIADEF_H

typedef enum amedia_status_t {
    AMEDIA_OK = 0,
...
#define AMIME_VIDEO_VP8         "video/x-vnd.on2.vp8"   //- VP8 video (i.e. video in .webm)
#define AMIME_VIDEO_VP9         "video/x-vnd.on2.vp9"   //- VP9 video (i.e. video in .webm)
#define AMIME_VIDEO_AVC         "video/avc"             //- H.264/AVC video
#define AMIME_VIDEO_HEVC        "video/hevc"            //- H.265/HEVC video
#define AMIME_VIDEO_MPEG4       "video/mp4v-es"         //- MPEG4 video
#define AMIME_VIDEO_H264        "video/3gpp"            //- H.263 video
#define AMIME_AUDIO_AMR_NB      "audio/3gpp"            //- AMR narrowband audio
#define AMIME_AUDIO_AMR_WB      "audio/amr-wb"          //- AMR wideband audio
#define AMIME_AUDIO_MP3         "audio/mpeg"            //- MPEG1/2 audio layer III
#define AMIME_AUDIO_RAW_AAC     "audio/mp4a-latm"       //- AAC audio (note, this is raw AAC packets, not packaged in LATM!)
#define AMIME_AUDIO_VORBIS      "audio/vorbis"          //- vorbis audio
#define AMIME_AUDIO_G711_ALAW   "audio/g711-alaw"       //- G.711 alaw audio
#define AMIME_AUDIO_G711_MLAW   "audio/g711-mlaw"       //- G.711 ulaw audio

#if 0
typedef enum amedia_format_key_t {
...
const char *AMediaCodec_getColorFormatName(int colorFormat);

// #define AMCTRACE INFO
// #define AMCTRACE(...) INFO(__VA_ARGS__)
